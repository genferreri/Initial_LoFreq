...
###WARNING - the percentage below is the new cutoff for the FD experiments
# Filter variants based on frequency >= 2%
...
write.table(AF.Cov.vcf, "AF.Cov.tsv", quote=FALSE, sep = "\t", row.names = F)
